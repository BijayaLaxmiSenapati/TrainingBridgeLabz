...
import com.bridgelabz.factory.SerializerFactory;
...
public class UserInterface {
	...
	private static void doSelectedOption(int option) {
		...
		case 2:
			...
			//person = serializer.getPersonsObjectByName(fname);
			//String thingToBeChanged = editPersonNewDetails();
	...
	/*private static String editPersonNewDetails() {
